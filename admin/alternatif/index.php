...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <!-- /.card -->
        <a href="http://localhost/ahpwp/admin/alternatif/add_alternatif.php" class="btn" style="background-color: #c9a677;"><i class="fas fa-plus mr-3"></i>Tambah Alternatif</a>
        <div class="card mt-3">
